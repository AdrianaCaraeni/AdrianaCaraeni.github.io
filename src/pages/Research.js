        ...
        <div className="flex-1 overflow-hidden flex flex-col items-center justify-center py-0 px-8 box-border gap-[20px] max-w-full">
          ...
          <div className="self-stretch overflow-hidden flex flex-col items-start justify-start py-10 px-6 box-border gap-[32px] max-w-full text-center text-5xl mq825:gap-[16px] mq825:pt-5 mq825:pb-5 mq450:pl-0 mq450:pr-0 mq825:box-border mq1425:pt-[26px] mq1425:pb-[26px] mq1425:box-border">
            ...
            <ExperienceComponent
              ...
              Text1="Developed a series of web pages to be deployed on Amazon Mechanical Turk, gathering data on LLM preferences, by integrating OpenAI API, Gemini, and ChatGPT-4o mini into the user interfaces."
            ...
            <ExperienceComponent
              ...
              Text2="Leveraged Java code to batch prompt OpenAI, facilitating the collection of hundreds of data points for analysis. Develop and integrate data collection and evaluation pipelines for GPT-4o in an NLP research project, including implementing rubric-based prompting, chain-of-thought (CoT) generation, zero- and few-shot learning techniques, and aligning with standard data splits and metrics for reproducibility."
            />
          </div>
        </div>
      </section>
